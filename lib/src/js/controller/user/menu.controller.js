export default function menuController() {
    ...
    function menuController($scope,$timeout, $q, $log,$location,$routeParams,$http) {
        ...
        $http.post(`/getMenu`).then(function(response){
            console.log(response.data,'subs-object')
            var menu = response.data
            // console.log(menu,'menu')
            var nonveg = menu.nonvegmeals
            console.log(nonveg,'nonveg-array')
            var veg = menu.vegmeals
            console.log(veg,'veg')

           var nonveg_object = nonveg[0];
           console.log(nonveg_object,'nonveg_object')
...
console.log(non_array,'non array')
...
console.log(veg_array,'veg array')
// veg
