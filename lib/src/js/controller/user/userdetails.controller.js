export default function userdetailsController() {
	...
	userdetailsController.$inject = ['$scope','$timeout', '$q', '$log','$http','$routeParams','$location'];
	function userdetailsController($scope,$timeout, $q, $log,$http,$routeParams,$location) {
        ...
        $scope.updateUser = function(){
            let data = {locality :vmUserdetails.locality, 
                        apartment :vmUserdetails.apartment, 
                        tower:vmUserdetails.tower,
