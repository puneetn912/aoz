export default function calenderController() {
	...
	function calenderController($scope,$timeout, $q, $log) {
        ...
        $scope.some= function(){
            ...
            if(objIndexVeg==-1){
                vmCalender.dayVegCount = 0
                console.log(vmCalender.currDate,'vmCalender.currDate')
                ...
                console.log(selectedDateSpan,'selectedDateSpan')
        ...
        {   
            console.log(new Date(lastDateVeg),'lastDateVeg')
            console.log(vmCalender.currDate,'vmCalender.currDate')
            let lastDateSpan = document.getElementById(`md-0-month-${lastDateVeg}`)
            console.log(lastDateSpan,'lastDateSpan')

            console.log(new Date(lastDateVeg).getDate(),'new Date(lastDateVeg).getDate()')
            // console.log(lastDateSpan.childNodes[1].attributes[1].value)
            // if (lastDateSpan.childNodes[1].attributes[1].value >= 1) {
