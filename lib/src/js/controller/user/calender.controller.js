	...
	function calenderController($scope,$timeout, $q, $log) {
        ...
        setTimeout(function(){
            for(var i=0;i<vegCount;i++){
                ...
                if(pastMonthtoday.charAt(7)==0){ pastMonthtoday=pastMonthtoday.slice(0, 7)+ pastMonthtoday.slice(8) }
            ...
            for(var i=0;i<nonvegCount;i++){
                ...
                if(pastMonthtoday1.charAt(7)==0){ pastMonthtoday1=pastMonthtoday1.slice(0, 7)+ pastMonthtoday1.slice(8) }
