export default function calenderController() {
	...
	function calenderController($scope,$timeout, $q,$log,$http,$routeParams,$location,$mdDialog,$mdToast) {
            ...
            if(response.data){
                setTimeout(function(){
                    ...
                    response.data.map((x,i)=>{
                        ...
                        var pastMonthtoday = `${nextDay.getFullYear()}-${nextDay.getMonth()+1}-${nextDay.getDate()}`;
                        console.log(pastMonthtoday,'pastMonthtoday')
        ...
        $scope.some= function(ev){
            console.log(document.getElementsByClassName('md-calendar-month-label md-calendar-label-clickable').attributes)
            document.getElementsByClassName('md-calendar-month-label md-calendar-label-clickable').innerHTML = 'HEy'
        ...
        $scope.caldveg = function(){
            ...
            if(vmCalender.dayVegCount == 0){
                ...
                if(timeCheck.getDay() == setTime.getDay()){
