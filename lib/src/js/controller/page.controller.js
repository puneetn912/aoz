export default function pageController() {
  ...
  function pageController($scope, $timeout, $mdSidenav, $log, $location, $routeParams, $http,$route,$cookies, $mdToast) {
    ...
    if(paramValue == 'static'){
        vmPage.phone = pageCookies.MasOassBqqLssIxxE ? pageCookies.MasOassBqqLssIxxE : ''
        vmPage.email = pageCookies.email ? pageCookies.email : '' 
        vmPage.name =  pageCookies.name ? pageCookies.name : ''
                    ...
                    if(i==formData.length-1){
                        if(vmPage.errMsg == ''){
                            ...
                            if(userData.name){
                                ...
                                console.log(userData.feedback_name,'userData.feedback_name')
