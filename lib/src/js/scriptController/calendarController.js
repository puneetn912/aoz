...
exports.resumeSub = (req,res,next)=>{
    ...
    Subscription.findOne(query).populate('apartment_id').exec((err,data)=>{if(err){console.log(err)}else{    
        ...
        let borderDate = new Date("Jan 19 2019")
        borderDate.setHours(15,30,0,0)
        ...
        serverDate.setHours(serverDate.getHours() + 14)
        console.log(serverDate, 'SERVERDATE SHOULD BE 19TH afternoon') 
        ...
        if(serverDate > borderDate ){
            ...
            console.log(serverDate, 'SERVERDATE SHOULD BE 19TH MIDNIGHT') 
        }

        // // let startDate = new Date()
        // let startDate = new Date("Jan 16 2019")  // 15
        // console.log(startDate,'startDate1')


        // // if today is past than 16th 10 o clock 
        // // then start date should be today

        // let setDate = new Date("Jan 20 2019")  //17
        ...
        // // 17,10am < 17,1pm
        // if(setDate<startDate){
        //     console.log('its past 10 today')
        //     // startDate = new Date()
        //     startDate.setDate(startDate.getDate()+1);
        //     console.log(startDate,'startDate3')
